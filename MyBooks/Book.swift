...
@Model class Book {
    ...
    // inicijalizator -> konstruktor
    init(
        // parametri inicijalizatora sa defaultnim vrijednostima
        // user upisuje vrijednosti za title i author
        title: String,
        author: String,
    ...
    // computed property za prikaz razlicitih ikona za statuse knjiga
    var icon: Image {
